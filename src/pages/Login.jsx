      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 bg-gradient-to-br from-violet-600 via-purple-500 to-fuchsia-400 p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-16">
            ...
            <span className="text-white font-bold text-xl tracking-tight">Nayalyzer</span>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-card border border-purple-50 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-xs">
                ...
                <button type="button" className="text-violet-500 hover:text-violet-700 font-medium">
                  Lupa password?
                </button>
              </div>
            ...
            <p className="text-center text-xs text-gray-400 mt-6">
              Gunakan email dan password apa saja untuk login demo.
            </p>
          </div>

          <p className="text-center text-xs text-gray-400 mt-4">
            Belum punya akun?{' '}
            <button className="text-violet-500 font-semibold hover:underline">Daftar gratis</button>
          </p>
        </div>
      </div>
    </div>
